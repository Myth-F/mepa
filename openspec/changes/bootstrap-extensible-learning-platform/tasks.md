...
- [ ] 3.1 Build accessible `/admin` module list, create, metadata edit, and draft management screens
- [ ] 3.2 Build the typed block editor with add, edit, remove, reorder, and actionable validation errors
...
- [ ] 4.3 Implement quiz attempts, scoring, module completion, progression display, and version-linked history
- [ ] 4.4 Implement ethical dilemma voting with one vote per learner and published dilemma version
...
- [ ] 7.3 Run the complete automated test suite and production build against the Docker Compose stack
